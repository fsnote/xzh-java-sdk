...
public class AesEncryptUtil {
     ...
     * @param text 需要解密的密文
     * @return 解密得到的明文
     * @throws XzhException aes解密失败
     */
    public String decrypt(String text) throws XzhException {
        byte[] original;
        try {
            // 设置解密模式为AES的CBC模式
            Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
        ...
        if (!from_appid.equals(appId)) {
            throw new XzhException(XzhErrorEnum.VALIDATE_APPID_ERROR);
        }
        return xmlContent;
     ...
     * @throws XzhException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public String encryptMsg(String replyMsg, String timeStamp, String nonce) throws XzhException {
        // 加密
